...
public class ProductController implements ServletContextAware{
   ...
   public ModelAndView getShopProductList(int topcategory_id, HttpServletRequest request) {      //하위카테고리의 id가 날라와야됨
      //상품카테고리 목록
      ...
      for(TopCategory topCategory : topList) {
    	  if(topCategory.getTopcategory_id() == topcategory_id) {
    		  ...
    		  for(SubCategory subCategory : subList) {
    			  productList = productService.selectById(subCategory.getSubcategory_id());   
    		  }
    	  }
      }
