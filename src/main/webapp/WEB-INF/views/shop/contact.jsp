<%@page import="com.koreait.petshop.model.common.MailSender"%>
                ...
                <div class="col-lg-5">
                    ...
                    <div class="contact-widget">
                        <div class="cw-item">
                            ...
                            <div class="ci-text">
                                <span>Address:</span>
                                <p>경기도 성남시 분당구 서현로210번길 16 유성트윈프라자1차</p>
                            </div>
                        </div>
                        <div class="cw-item">
                            <div class="ci-icon">
...
var mapCenter = new kakao.maps.LatLng(37.38553124574045, 127.12473567432899), // 지도의 중심좌표
    mapOption = {
